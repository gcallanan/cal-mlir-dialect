...
class CalSwitchBarFoo
    : public impl::CalSwitchBarFooBase<CalSwitchBarFoo> {
public:
  using impl::CalSwitchBarFooBase<
      CalSwitchBarFoo>::CalSwitchBarFooBase;
  void runOnOperation() final {
    RewritePatternSet patterns(&getContext());
    patterns.add<CalSwitchBarFooRewriter>(&getContext());
