module {
  ...
  cal.network @fft__Top()
  {
    ...
    cal.connect %s1 : !cal.instance<@fft__Sine__v__d_dyn> "Out" -> %add1 : !cal.instance<@fft__Add__T_f32> "A" capacity(4096)
    cal.connect %s2 : !cal.instance<@fft__Sine__v__d_dyn> "Out" -> %add1 : !cal.instance<@fft__Add__T_f32> "B" capacity(4096)
    cal.connect %add1 : !cal.instance<@fft__Add__T_f32> "Out" -> %add2 : !cal.instance<@fft__Add__T_f32> "A" capacity(4096)
    cal.connect %s3 : !cal.instance<@fft__Sine__v__d_dyn> "Out" -> %add2 : !cal.instance<@fft__Add__T_f32> "B" capacity(4096)
    ...
    ports_out(%Out: !fifo.input_port<f32>)
  {
    ...
    cal.connect %bf : !cal.instance<@fft__Butterfly> "Out" -> %scaler : !cal.instance<@fft__ConstantMultiply__T_f32__v__c_dyn> "In" capacity(4096)
    cal.connect %scaler : !cal.instance<@fft__ConstantMultiply__T_f32__v__c_dyn> "Out" -> %Out : !fifo.input_port<f32> "in" capacity(4096)
  } loc(#loc31)
    ...
    ports_out(%Out: !fifo.input_port<f32>)
  {
    ...
    cal.connect %In : !fifo.output_port<f32> "out" -> %split : !cal.instance<@fft__Split__T_f32__v__N_dyn> "In" capacity(4096)
    cal.connect %In : !fifo.output_port<f32> "out" -> %twiddles : !cal.instance<@fft__TwiddleGenerator__T_f32__v__N_dyn> "Trigger" capacity(4096)
    cal.connect %merge : !cal.instance<@fft__Merge__T_f32> "Out" -> %Out : !fifo.input_port<f32> "in" capacity(4096)
    cal.connect %split : !cal.instance<@fft__Split__T_f32__v__N_dyn> "A" -> %r2cell : !cal.instance<@fft__Radix2Cell__T_f32> "X0" capacity(4096)
    cal.connect %split : !cal.instance<@fft__Split__T_f32__v__N_dyn> "B" -> %r2cell : !cal.instance<@fft__Radix2Cell__T_f32> "X1" capacity(4096)
    cal.connect %twiddles : !cal.instance<@fft__TwiddleGenerator__T_f32__v__N_dyn> "W" -> %r2cell : !cal.instance<@fft__Radix2Cell__T_f32> "W" capacity(4096)
    ...
    scf.if %t23 {
      ...
      cal.connect %r2cell : !cal.instance<@fft__Radix2Cell__T_f32> "Y0" -> %bf[%t25] : !cal.instance.array<@fft__Butterfly, [?]> "In" capacity(4096)
      %t26 = arith.constant 1 : i32 loc(#loc53)
      %t27 = arith.index_cast %t26 : i32 to index
      cal.connect %r2cell : !cal.instance<@fft__Radix2Cell__T_f32> "Y1" -> %bf[%t27] : !cal.instance.array<@fft__Butterfly, [?]> "In" capacity(4096)
      %t28 = arith.constant 0 : i32 loc(#loc54)
      %t29 = arith.index_cast %t28 : i32 to index
      cal.connect %bf[%t29] : !cal.instance.array<@fft__Butterfly, [?]> "Out" -> %merge : !cal.instance<@fft__Merge__T_f32> "A" capacity(4096)
      %t30 = arith.constant 1 : i32 loc(#loc55)
      %t31 = arith.index_cast %t30 : i32 to index
      cal.connect %bf[%t31] : !cal.instance.array<@fft__Butterfly, [?]> "Out" -> %merge : !cal.instance<@fft__Merge__T_f32> "B" capacity(4096)
    } else {
...
#loc103 = loc("/Users/endrix/git/streamblocks/langium-cal/examples/fft/Top.cal":1:1)