...
streamblocks mlir --set generate-single-declaration-per-actor=off --set experimental-network-elaboration=on --source-path PrecisePi.cal --target-path myproject precisepi.PrecisePiNetwork
