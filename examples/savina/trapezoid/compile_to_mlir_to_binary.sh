...
streamblocks mlir --set generate-single-declaration-per-actor=off --set experimental-network-elaboration=on --source-path Trapezoid.cal --target-path myproject trapezoid.TrapezoidNetwork
