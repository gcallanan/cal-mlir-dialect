...
streamblocks multicore --set experimental-network-elaboration=on --set reduction-algorithm=ordered-condition-checking --source-path PingPong.cal --target-path myproject pingpong.PingPongNetwork
...
cd ../..
cp myproject/bin/PingPongNetwork main_executable_from_cpp
