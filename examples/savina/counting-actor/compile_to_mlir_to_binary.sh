...
streamblocks mlir --set generate-single-declaration-per-actor=off --set experimental-network-elaboration=on --source-path CountingActor.cal --target-path myproject countingactor.CountingActorNetwork
