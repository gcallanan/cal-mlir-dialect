...
// Minimal actor declaration to satisfy instance handle types
cal.actor @A() { }

cal.network @n() {
  // Two handles, choose at compile time via cal.instance_if
  ...
  // After resolve-instance-if, the result should be folded to %hA
