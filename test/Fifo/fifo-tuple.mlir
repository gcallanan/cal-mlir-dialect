...
%output1 = "fifo.get_tuple_element"(%tuple1) {index = 0 : i32} : (tuple<i32, i32>) -> i32
// CHECK: %1 = "fifo.get_tuple_element"(%0) <{index = 0 : i32}> : (tuple<i32, i32>) -> i32
...
%output2 = "fifo.get_tuple_element"(%tuple2) {index = 0 : i32} : (tuple<memref<1xi32>, memref<1xi32>>) -> memref<1xi32>
// CHECK: %3 = "fifo.get_tuple_element"(%2) <{index = 0 : i32}> : (tuple<memref<1xi32>, memref<1xi32>>) -> memref<1xi32>