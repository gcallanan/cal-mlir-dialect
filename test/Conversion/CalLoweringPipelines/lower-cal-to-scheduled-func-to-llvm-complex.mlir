...
//CHECK-NEXT: Q5: row 1: 452564 -264697 
//CHECK-NEXT: R5: row 0: 321895 400790 
	...
	ports_out(%Out: !fifo.input_port<i22>)
{
	...
	// Evaluate global variable num_matrices.
	%tmp_6 = arith.constant 15 : i4
	%tmp_7 = arith.extui %tmp_6 : i4 to i32
