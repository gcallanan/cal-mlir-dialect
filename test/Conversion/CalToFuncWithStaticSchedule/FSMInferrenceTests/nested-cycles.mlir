...
//CHECK: FSM for actor: nestedCyclesActor. Type: FSM (Unclassified)
...
//CHECK-NEXT:     -> Next: Node 2
//CHECK-NEXT:   Node 5: action5
//CHECK-NEXT:     -> Next: Node 1


//-- Definition of actor class: NestedCyclesActor
cal.actor @nestedCyclesActor ()
{
	// -- Actor body
	...
	cal.action "action1" priority=0 {
		...
		cal.set(%l_state__2: !cal.state_ref<i32>, %tmp_17: i32)
		// Assignment Statement: End
		// Assignment Statement: Start
	...
	cal.action "action2" priority=0 {
		// Guard: Start
		cal.predicate {
			%tmp_20 = cal.get(%l_state__2: !cal.state_ref<i32>) : i32
		...
		%tmp_28 = arith.cmpi slt, %tmp_25, %tmp_27 : i32
		scf.if %tmp_28 {
			// Assignment Statement: Start
			%tmp_29 = arith.constant 3 : i2
			%tmp_30 = arith.extui %tmp_29 : i2 to i32
			cal.set(%l_state__2: !cal.state_ref<i32>, %tmp_30: i32)
			// Assignment Statement: End
		} else {
			// Assignment Statement: Start
			%tmp_31 = arith.constant 5 : i3
	...
	cal.action "action5" priority=0 {
		// Guard: Start
		cal.predicate {
			%tmp_51 = cal.get(%l_state__2: !cal.state_ref<i32>) : i32
			%tmp_52 = arith.constant 5 : i3
			%tmp_53 = arith.extui %tmp_52 : i3 to i32
			%tmp_54 = arith.cmpi eq, %tmp_51, %tmp_53 : i32
			cal.predicate_result %tmp_54 : i1
		}
		// Guard: End
		// Call Statement: Start
		fifo.print("In state 5, taking action5\n\00")
		// Call Statement: End
		// Assignment Statement: Start
		%tmp_55 = arith.constant 1 : i1
		%tmp_56 = arith.extui %tmp_55 : i1 to i32
		cal.set(%l_state__2: !cal.state_ref<i32>, %tmp_56: i32)
		// Assignment Statement: End
		// Assignment Statement: Start
...
cal.network
{
	...
	cal.create_instance @nestedCyclesActor "nestedCyclesActor" ()
