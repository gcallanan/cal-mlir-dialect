...
//-- Definition of actor class: BranchingActor
cal.actor @branchingActor ()
{
	// -- Actor body
	...
	cal.action "action5" priority=0 {
		...
		// Call Statement: End
		// Assignment Statement: Start
		%tmp_47 = arith.constant 5 : i3
		%tmp_48 = arith.extui %tmp_47 : i3 to i32
...
cal.network
{
	...
	cal.create_instance @branchingActor "branchingActor" ()
