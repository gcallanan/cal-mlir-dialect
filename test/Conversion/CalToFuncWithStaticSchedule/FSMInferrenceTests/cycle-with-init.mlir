...
//CHECK: FSM for actor: cycleWithInitActor. Type: FSM (Unclassified)
...
//-- Definition of actor class: CycleWithInitActor
cal.actor @cycleWithInitActor ()
{
	// -- Actor body
	...
	cal.action "action3" priority=0 {
		...
		%tmp_33 = arith.extui %tmp_32 : i2 to i32
...
cal.network
{
	...
	cal.create_instance @cycleWithInitActor "cycleWithInitActor" ()
