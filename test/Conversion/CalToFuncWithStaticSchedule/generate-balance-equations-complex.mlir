...
// CHECK-NEXT:   Equation 0: joinersPerRow_r_0: p_c * 2 == caps_r_0: c_c * -1
// CHECK-NEXT:   Equation 1: iGenerator_1: p_c * 1 == innerCells_q_1: c_c * -2
// CHECK-NEXT:   Equation 2: innerCells_q_2: p_c * 2 == innerCells_q_3: c_c * -2
// CHECK-NEXT:   Equation 3: boundaryCells_1: p_c * 2 == innerCells_q_2: c_c * -2
// CHECK-NEXT:   Equation 4: innerCells_q_0: p_c * 2 == innerCells_q_1: c_c * -2
// CHECK-NEXT:   Equation 5: boundaryCells_1: p_c * 1 == joinersPerRow_r_1: c_c * -1
// CHECK-NEXT:   Equation 6: joinersPerRow_q_0: p_c * 2 == caps_q_0: c_c * -1
// CHECK-NEXT:   Equation 7: innerCells_q_0: p_c * 2 == innerCells_q_2: c_c * -2
// CHECK-NEXT:   Equation 8: innerCells_q_2: p_c * 2 == caps_x_0: c_c * -1
// CHECK-NEXT:   Equation 9: innerCells_q_1: p_c * 1 == joinersPerRow_q_1: c_c * -1
// CHECK-NEXT:   Equation 10: innerCells_r_0: p_c * 1 == joinersPerRow_r_0: c_c * -1
// CHECK-NEXT:   Equation 11: innerCells_q_3: p_c * 1 == joinersPerRow_q_1: c_c * -1
// CHECK-NEXT:   Equation 12: joinersPerRow_r_1: p_c * 1 == caps_r_1: c_c * -1
// CHECK-NEXT:   Equation 13: innerCells_q_3: p_c * 2 == caps_cordic_1: c_c * -1
// CHECK-NEXT:   Equation 14: boundaryCells_0: p_c * 2 == innerCells_r_0: c_c * -2
// CHECK-NEXT:   Equation 15: iGenerator_0: p_c * 1 == innerCells_q_0: c_c * -2
// CHECK-NEXT:   Equation 16: innerCells_q_1: p_c * 2 == caps_cordic_0: c_c * -1
// CHECK-NEXT:   Equation 17: source: p_c * 1 == innerCells_r_0: c_c * -2
// CHECK-NEXT:   Equation 18: innerCells_r_0: p_c * 2 == innerCells_q_0: c_c * -2
// CHECK-NEXT:   Equation 19: source: p_c * 1 == boundaryCells_0: c_c * -2
// CHECK-NEXT:   Equation 20: boundaryCells_0: p_c * 1 == joinersPerRow_r_0: c_c * -1
// CHECK-NEXT:   Equation 21: joinersPerRow_q_1: p_c * 2 == caps_q_1: c_c * -1
// CHECK-NEXT:   Equation 22: innerCells_q_3: p_c * 2 == caps_x_1: c_c * -1
// CHECK-NEXT:   Equation 23: innerCells_q_0: p_c * 1 == joinersPerRow_q_0: c_c * -1
// CHECK-NEXT:   Equation 24: innerCells_r_0: p_c * 2 == boundaryCells_1: c_c * -2
// CHECK-NEXT:   Equation 25: innerCells_q_1: p_c * 2 == innerCells_q_3: c_c * -2
// CHECK-NEXT:   Equation 26: innerCells_q_2: p_c * 1 == joinersPerRow_q_0: c_c * -1
