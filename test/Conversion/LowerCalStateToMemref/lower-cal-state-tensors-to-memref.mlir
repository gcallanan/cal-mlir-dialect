// RUN: cal-opt --one-shot-bufferize --lower-cal-state-to-memref --buffer-deallocation %s | FileCheck %s
...
//CHECK: linalg.fill ins(%cst : f64) outs(%alloc : memref<2x2xf64>)
//CHECK: memref.copy %alloc, %alloc : memref<2x2xf64> to memref<2x2xf64>
...
//CHECK: linalg.add ins(%alloc_3, %alloc : memref<2x2xf64>, memref<2x2xf64>) outs(%alloc : memref<2x2xf64>)
//CHECK: memref.copy %alloc, %alloc : memref<2x2xf64> to memref<2x2xf64>