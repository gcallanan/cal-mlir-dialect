...
cal.actor @my_actor2()
// expected-error @+1 {{custom op 'cal.actor' expected fifo.input_port<...> for ports_out argument}}
...
cal.actor @my_actor3()
// expected-error @+1 {{custom op 'cal.actor' expected fifo.output_port<...> for ports_in argument}}
