...
cal.network @N() {
  ...
  // CHECK: %[[H:.*]] = cal.instance_at %[[ARR]][%c1] : !cal.instance.array.iface<@I, [3]> -> !cal.instance.iface<@I>
  %h = cal.instance_at %arr[%c1] : !cal.instance.array.iface<@I, [3]> -> !cal.instance.iface<@I>
}
